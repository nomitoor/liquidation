...
class ContainerController extends Controller
{
    ...
    {
        return Excel::download(new ContainerExport($container), $container->id . '-' . $container->name . '-' . 'containers.xlsx');
    }

    public function exportContainersClient(Container $container)
    {
        return Excel::download(new ContainerClientExport($container), $container->id . '-' . $container->name . '-' . 'containers-client.xlsx');
    }
}
