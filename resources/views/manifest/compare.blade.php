...
@section('title', 'Compare manifest')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Upload your weekly manifest to compare</h4>
                </div>
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" id="upload-file" action="{{ route('downloadUpdatedManifest') }}">
                        {{ csrf_field() }}
                        <div class="row">

                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="file" name="uploaded_file" placeholder="Choose file" id="file">
                                    @error('file')
