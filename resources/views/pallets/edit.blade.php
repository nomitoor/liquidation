                        ...
                        <form method="POST" enctype="multipart/form-data" id="upload-file"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-1">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control product_code_manually"
                                            placeholder="Enter product ID or Bol ID" />
                                        <span class="input-group-btn">
                                                            ...
                                                            <th>
                                                                <div class="elipsis">
                                                                    <img style="width:25px;cursor:pointer"
                                                                        onclick="deletePallet('<?php echo $pallets->id; ?>','<?php echo $product->package_id; ?>', '<?php echo $product->bol; ?>')"
                                                                        src="https://eccdatacenter.ae/umeattendance/Images/Close_Rej.jpg">
                                                                </div>
                                                            </th>
                                                            <th>
